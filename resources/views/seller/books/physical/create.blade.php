                            ...
                            <div class="col-span-1 md:col-span-2 space-y-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="bookTitle" name="title" value="{{ old('title') }}" required
                                        class="mt-1 block w-full border-b border-gray-300 focus:border-green-500 focus:ring-green-500 outline-none sm:text-sm @error('title') border-red-500 @enderror">
                                    @error('title')
                                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input type="text" id="bookAuthor" name="author" value="{{ old('author') }}"
                                            required
                                            class="mt-1 block w-full border-b border-gray-300 focus:border-green-500 focus:ring-green-500 outline-none sm:text-sm @error('author') border-red-500 @enderror">
                                        @error('author')
                                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    <div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="number" id="bookPrice" name="price" value="{{ old('price') }}"
                                                ...
                                                class="mt-1 block w-full pl-7 border-b border-gray-300 focus:border-green-500 focus:ring-green-500 outline-none sm:text-sm @error('price') border-red-500 @enderror">
                                        </div>
                                        @error('price')
                                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                        @enderror
                                ...
                                <div>
                                    ...
                                    <input type="text" id="LocationBook" name="location" value="{{ old('location') }}"
                                        required
                                ...
                                <div>
                                    ...
                                    <textarea id="bookDescription" name="description" rows="3" required
                                        class="mt-1 block w-full border-b border-gray-300 focus:border-green-500 focus:ring-green-500 outline-none sm:text-sm @error('description') border-red-500 @enderror">{{ old('description') }}</textarea>
                                    @error('description')
                                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
