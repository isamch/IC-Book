            ...
            <div class="rounded-xl p-6">
                ...
                <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                            ...
                            <div class="col-span-1 md:col-span-2 flex flex-col justify-between">
                                <div class="space-y-6">
                                    ...
                                    <div class="border-t border-gray-200 pt-6">
                                        ...
                                        <a href="{{ route('seller.profile.show', $electronicBook->book->seller->user->id) }}" class="mt-4 flex items-center">
                                            <img id="sellerImage"
                    ...
                    <div class="bg-gray-50 px-6 py-4 border-t border-gray-200 flex justify-end space-x-4">
                        ...
                        <a href="{{ route('seller.books.edit', $electronicBook->id) }}" type="button"
                            id="contactSellerBtn"
