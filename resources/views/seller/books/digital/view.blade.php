        ...
        <div class="flex-1 overflow-y-auto p-8">
            ...
            <div class="bg-white rounded-xl shadow-lg p-6">
                ...
                <div class="flex justify-between items-center mb-6">
                    ...
                    <button class="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700">Add New Book</button>
                </div>
                            ...
                            <div class="p-6">
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                                    ...
                                    <div class="col-span-1 flex justify-center">
                                        <img id="bookCover" src="{{ asset('storage/' .  $electronicBook->book->images->first()->image )}}" alt="Book cover"
                                        ...
                                        <div class="space-y-6">
                                            ...
                                            {{-- <div class="border-t border-gray-200 pt-6">
                                                ...
                                                <div class="mt-4 flex items-center">
                                                    ...
                                                    <div class="ml-4">
                                                        <p id="sellerName" class="text-lg font-medium text-gray-900"></p>
                                                        <p id="sellerEmail" class="text-sm text-gray-500"></p>
                                                        <p id="sellerPhone" class="text-sm text-gray-500 mt-1"></p>
                                                    </div>
                                                </div>
                                            </div> --}}
                                        </div>
