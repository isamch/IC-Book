...
class RegisterRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'birthdate' => 'required|date|regex:/^\d{4}-\d{2}-\d{2}$/|before_or_equal:'. now()->subYears(18)->toDateString(),
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'user_type.in' => 'The role must be either "Seller" or "Client".',
            ...
            'birthdate.regex' => 'The birthdate must be a valid date.',
        ];
    }
